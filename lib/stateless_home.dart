// stateless widget is a widget that does not change its state. hence when we convert the currency then its getting converted.
// we can verify it in the console print but to update it in the UI  we need a statefull widget. hence after this you will find complete statefull code in the home.dart page
